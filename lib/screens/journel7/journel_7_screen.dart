...
import '../tradeMil/trade_mil_screen.dart';

//Journel professional Screen.
                  ...
                  panel: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        //   height: 10,
                        // ),
                        (value.user?.professionalAccount ?? false)
                            ? Padding(
                                padding: const EdgeInsets.all(20),
                                child: TextField(
                                ...
                                builder: (context, value, child) => ButtonWidget(
                                  ...
                                  onTap: () async {
                                    if (_notesController.text.isNotEmpty) {
                                      widget.userModel!.programs.notes.add(
                                        NotesModel(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: (value.user?.professionalAccount ?? false)
                                            ? Text(
                                                (userStream?.weight?.length ?? 0) == 0
                                                    ? '0.0'
                                      ...
                                      : GestureDetector(
                                          onTap: () {
                                            Get.to(() => TradeMilScreen(
                                                type: 'Stretch', userProgramModel: widget.userProgramModel));
                                          },
                                          child: Text(
                                            '+ Stretches',
                                            style: AppConstants.bulkinDaysTextStyle
                                                .copyWith(color: AppColors.darkerBlueBorder),
                                          ),
                                        ),
                                  Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                  ...
                                  (value.user?.professionalAccount ?? false)
                                      ...
                                      : GestureDetector(
                                          onTap: () {
                                            Get.to(() => TradeMilScreen(
                                                type: 'Exercise', userProgramModel: widget.userProgramModel));
                                          },
                                          child: Text(
                                            '+ Exercises',
                                            style: AppConstants.bulkinDaysTextStyle
